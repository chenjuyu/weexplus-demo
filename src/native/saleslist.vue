            ...
            mobile(e, node, i) {
                ...
                Binding.bind(
                    ...
                    e => {
                        ...
                        if (state === "end") {
                            this.log('deltaX:'+deltaX) //大于0向右，小于0向左
                            //备份  this.mobileX += deltaX;
                            if(deltaX !=0) {
                                this.mobileX = deltaX //deltaX =0时，相关于点击
                            }
                            this.movingDistance(this.mobileX, node, el);

                            this.log('mobileX:'+this.mobileX)
                        }
                    }
                );
            },
...
<style scoped>
    ...
    .input_bg{ /*position: absolute; background-color: #0085ee; top: 60px;bottom: 60px; 170 #1EA5FC;*/
        top:50;
