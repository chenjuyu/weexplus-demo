<template>
    <div class="container">
        ...
        <div class="search">
            <input type="text" style="width: 500px;height: 80px;border-width: 1px;background-color: #D3D3D3;border-color: #f5f5f5;margin-left: 10px" return-key-type="search" v-model="No" @input="search" placeholder="输入单号查询"/>
            <div style="border-width: 1px;border-color: #D3D3D3;height: 80px;width: 200px;align-items:center;justify-content: center"><text @click="add" style="font-size: 35px;">增加单据</text> </div>
        </div>
