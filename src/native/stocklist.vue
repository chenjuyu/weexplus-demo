<template>
    <div class="container">
        ...
        <div class="footer">
            ...
            <div style="height: 80px;justify-content: center;align-items: center;position: absolute;right: 0;bottom: 0"> <text style="font-size: 40px;color: #666666;">结算金额:￥{{totalAmt}}</text></div>
        </div>
    </div>
</template>
